#MaxSens1 multi threads

@with_kw struct MaxSens1
    resolution::Float64 = 1.0
    tight::Bool         = false
end

# This is the main function
function solve(solver::MaxSens1, problem::Problem) #multi threads
    result = true
...
function forward_layer(solver::MaxSens1, L::Layer, input::Hyperrectangle)
...
function forward_node(solver::MaxSens1, node::Node, input::Hyperrectangle)
