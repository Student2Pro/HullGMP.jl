#HullReach1 multi threads

@with_kw struct HullReach1
    resolution::Float64 = 1.0
    tight::Bool         = false
end

# This is the main function
function solve(solver::HullReach1, problem::Problem) #multi threads
    result = true
...
function forward_layer(solver::HullReach1, L::Layer, input::Hyperrectangle)
...
function forward_node(solver::HullReach1, node::Node, input::Hyperrectangle)
