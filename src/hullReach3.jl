#HullReach3 test runtime not hull

@with_kw struct HullReach3
    resolution::Float64 = 1.0
    tight::Bool         = false
end

# This is the main function
function solve(solver::HullReach3, problem::Problem) #original
    result = true
...
function forward_layer(solver::HullReach3, L::Layer, input::Hyperrectangle)
...
function forward_node(solver::HullReach3, node::Node, input::Hyperrectangle)
