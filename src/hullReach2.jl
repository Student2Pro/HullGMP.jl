#HullReach2 multi tasks

@with_kw struct HullReach2
    resolution::Float64 = 1.0
    tight::Bool         = false
end

# This is the main function
function solve(solver::HullReach2, problem::Problem) #multi tasks
    result = true
...
function forward_layer(solver::HullReach2, L::Layer, input::Hyperrectangle)
...
function forward_node(solver::HullReach2, node::Node, input::Hyperrectangle)
